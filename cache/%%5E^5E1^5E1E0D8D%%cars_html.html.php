<?php /* Smarty version 2.6.18, created on 2017-03-16 08:45:52
         compiled from admins/cars_html.html */ ?>
...
?m=create_html&a=cars&op=1');"/>
						</p>
						<p>更新最新发布的
							<input type="text" name="carsnum" size="5" value="20">
							条信息
							<input type="button" class="button" value="开始更新" onclick="submithtml('<?php echo $this->_tpl_vars['adminpage']; ?>
?m=create_html&a=cars&op=2');"/>
						</p>
						<p>更新发布时间从
