<?php /* Smarty version 2.6.18, created on 2017-03-16 08:30:59
         compiled from admins/cars_list.html */ ?>
...
?m=cars&a=add" class="add">添加车源</a></li>
        ...
        游客: <?php if ($this->_tpl_vars['visitorcount'] == ''): ?><span class="orange01">0</span> 条<?php else: ?><span class="orange01"><?php echo $this->_tpl_vars['visitorcount']; ?>
</span> 条<?php endif; ?>,
        待审核: <?php if ($this->_tpl_vars['unauditedcount'] == ''): ?><span class="orange01">0</span> 条<?php else: ?><span class="orange01"><?php echo $this->_tpl_vars['unauditedcount']; ?>
</span> 条<?php endif; ?>,
        已出售: <?php if ($this->_tpl_vars['issellcount'] == ''): ?><span class="orange01">0</span> 条<?php else: ?><span class="orange01"><?php echo $this->_tpl_vars['issellcount']; ?>
</span> 条<?php endif; ?>,
        未出售: <?php if ($this->_tpl_vars['nosellcount'] == ''): ?><span class="orange01">0</span> 条<?php else: ?><span class="orange01"><?php echo $this->_tpl_vars['nosellcount']; ?>
...
?m=cars" method="POST" name="form" onSubmit="return listsubmitconfirm(this.form)">
	...
	<tr><th width="30">选择</th><th>ID</th><th>信息编号</th><th align="left">品牌</th><th>车型</th><th>报价</th><th>上牌日期</th><th>发布时间</th><?php if ($this->_tpl_vars['setting']['version'] == 2 || $this->_tpl_vars['setting']['version'] == 3): ?><th>会员</th><?php endif; ?><?php if ($this->_tpl_vars['setting']['version'] == 3): ?><th>城市</th><?php endif; ?><th>状态</th><th>派单</th><th>已卖</th><th>点击</th><th width="230">操作</th></tr>
...
"></td>
	...
	<td align="center"><?php echo $this->_tpl_vars['cars']['p_no']; ?>
</td>
...
-<?php echo $this->_tpl_vars['cars']['city']; ?>
	...
	<?php endif; ?>
	<td align="center"><?php if ($this->_tpl_vars['cars']['isshow'] == 1): ?><span class="green">已审核</span><?php else: ?><span class="red">未审核</span><?php endif; ?></td>
	<td align="center">
		<!--<input type="text" readonly style=""/>
		<select id="pd" onchange="">
			<option value="">请选择</option>
			<option value="">检车派单</option>
			<option value="">销售派单</option>
			<option value="">客服跟单</option>
		</select>-->
		<?php if ($this->_tpl_vars['cars']['is_paidan'] == 1): ?><span class="green">已派单</span><?php else: ?><a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=paidan&p_id=<?php echo $this->_tpl_vars['cars']['p_id']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
"> <span class="red">派单</span></a><?php endif; ?>
	</td>
	...
	<td align="center" class="rightmenu">
		<a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=cars&a=html&id=<?php echo $this->_tpl_vars['cars']['p_id']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
">生成静态</a> |
		<?php if ($this->_tpl_vars['cars']['isshow'] == 0): ?>
			<a href="<?php echo $this->_tpl_vars['adminpage']; ?>
...
">未审</a> |
		<?php else: ?>
			<a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=cars&a=show&id=<?php echo $this->_tpl_vars['cars']['p_id']; ?>
&p_state=<?php if ($this->_tpl_vars['cars']['isshow'] == 0): ?>1<?php else: ?>0<?php endif; ?>&page=<?php echo $this->_tpl_vars['page']; ?>
">已审</a> |
		<?php endif; ?>
